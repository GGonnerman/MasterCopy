function setVariable() {
   ...
   document.getElementById("output").innerHTML = "In Centimeters" + "<br>" + "Side A: " + a + "<br>" + "Side B: " + b + "<br>" + "Side C: " + c + "<br>" + "Height: " + height + "<br>" + "Slant Height: " + slantHeight + "<br>" + "Area of Base: " + areaBase + "<br>" + "Surface Area: " + surfaceArea + "<br>" + "Volume: " + volume + "<br>" + "Weight in Gold (Grams): " + weight + "<br>" + "Price in Gold: " + priceGold;
